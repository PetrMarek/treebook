...
class UserFriendshipsControllerTest < ActionController::TestCase
	context "#index" do
		...
		context "when logged in" do
			...
			should "assigns user_friendship" do
			...
			should "display pending information on a accepted friendship" do
				assert_select "#user_friendship_#{@friendship2.id}" do
					assert_select "em", "Friendship active #{@friendship2.updated_at}."
				end
			end
		end
	end
...
# 1) Error:
# test: #destroy should delete user friendships. (UserFriendshipsControllerTest):
# ActionController::RoutingError: No route matches {:id=>nil, :controller=>"user_friendships", :action=>"destroy"}

# 2) Error:
# test: #destroy should set the flash. (UserFriendshipsControllerTest):
# ActionController::RoutingError: No route matches {:id=>nil, :controller=>"user_friendships", :action=>"destroy"}
